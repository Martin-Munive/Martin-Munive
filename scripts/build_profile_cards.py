...
def build_rhythm_card(contrib: dict[str, Any]) -> str:
    ...
    parts = svg_header(
        ...
        "Mapa de calor de 30 semanas y volumen semanal; se actualiza por workflow, no al cargar el README",
        820,
        300,
    )
    ...
    parts.extend(
        [
            f'<text x="512" y="222" font-family="Segoe UI, Inter, Arial, sans-serif" font-size="12" fill="{MUTED}">Ultimos 7 dias</text>',
            f'<text x="512" y="248" font-family="Segoe UI, Inter, Arial, sans-serif" font-size="24" font-weight="700" fill="{GREEN}">{metric(last_7)}</text>',
            f'<text x="642" y="222" font-family="Segoe UI, Inter, Arial, sans-serif" font-size="12" fill="{MUTED}">Ultimos 30 dias</text>',
            f'<text x="642" y="248" font-family="Segoe UI, Inter, Arial, sans-serif" font-size="24" font-weight="700" fill="{AMBER}">{metric(last_30)}</text>',
            f'<text x="28" y="276" font-family="Segoe UI, Inter, Arial, sans-serif" font-size="11" fill="{MUTED}">Los conteos siguen la ventana de contribuciones publica de GitHub; pueden diferir de eventos de push recien procesados.</text>',
        ]
    )
    return svg_footer(parts)
